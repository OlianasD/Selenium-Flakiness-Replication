...
public class Installer {
	...
	public void install() throws InterruptedException {
		...
		wait.waitClickability(By.id("set_license")).click();
		driver.findElement(By.id("btNext")).click();
		wait.waitClickability(By.id("infosShop")).sendKeys("E2E Web Testing store");
		...
		driver.findElement(By.id("btNext")).click();
		wait.waitClickability(By.id("dbServer")).clear();
		...
		//Thread.sleep(5000);
		new Wait(driver, 120).waitClickability(By.id("btCreateDB")).click();
		//Thread.sleep(5000);
		new Wait(driver, 120).waitClickability(By.id("btNext")).click();
