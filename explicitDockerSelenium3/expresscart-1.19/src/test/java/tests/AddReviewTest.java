...
public class AddReviewTest extends BaseTest {
	...
	public void testExpressCartAddReview() throws Exception {
		...
		assertEquals("Title: Review000", product.getReviewTitle("Title: Review000"));
		assertEquals("Description: Description000", product.getReviewDescription("Description: Description000"));
		assertEquals("Rating: 5", product.getReviewRating("Rating: 5"));
	}
